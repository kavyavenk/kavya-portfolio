      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-gray-400 mt-6 max-w-2xl mx-auto">
            I'm currently pursuing my Master's at Columbia and
            open to exciting opportunities in AI, data science,
            and technology consulting. Let's discuss how we can
            collaborate!
          </p>
        </motion.div>
          ...
          >
            <div>
              ...
              <p className="text-gray-400 leading-relaxed mb-8">
                I'm passionate about leveraging AI and data
                science for social impact. Whether you're
                interested in discussing research
                collaborations, consulting opportunities, or
                innovative projects that bridge technology and
                social good, I'd love to hear from you.
              </p>
            </div>
            ...
            >
              ...
              <p className="text-gray-300 text-sm mb-2">
                🎓 MS Computer Science at Columbia University
                (2025-2026)
              </p>
              <p className="text-gray-300 text-sm mb-2">
                💼 AI & Data Technology Consulting Intern at
                Ernst & Young
              </p>
              <p className="text-gray-300 text-sm">
                🔍 Open to research collaborations and
                intern/co-op/full-time opportunities
              </p>
            </motion.div>
          </motion.div>
        </div>
        ...
        >
          <p className="text-gray-400">
            © 2025 Kavya Venkatesh. Designed &amp; Built with
            ❤️ using React and Tailwind CSS.
          </p>
          <p className="text-gray-500 text-sm mt-2">
            Trained Carnatic Singer • Avid Reader • Movie
            Enthusiast • Keen Writer • Aspiring Art Connoisseur
          </p>
        </motion.div>
      </div>
    </section>
