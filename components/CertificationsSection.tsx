...
export function CertificationsSection() {
  const certifications = [
    {
      title:
        "EY - Artificial Intelligence - AI Engineering - Silver Learning",
      issuer: "Ernst & Young",
      date: "July 2025",
      skills: [
        "Generative AI",
    ...
    {
      title:
        "Group 2 Social / Behavioral Research Investigators",
      issuer: "CITI Program",
      date: "January 2024",
    ...
    {
      title:
        "Understanding Gender Roles Through South Asian Media",
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-gray-400 mt-6 max-w-2xl mx-auto">
            Continuous learning through industry-recognized
            certifications in AI, machine learning, and
            technology
          </p>
        </motion.div>
              ...
              >
                <Card className="p-6 bg-gray-900/50 border-white/10 hover:border-blue-400/50 transition-all duration-300 group h-full">
                  <div className="flex items-start justify-between mb-4">
                    <div
                      className={`p-2 rounded-lg bg-gradient-to-r ${categoryColors[cert.category]} bg-opacity-20`}
                    >
